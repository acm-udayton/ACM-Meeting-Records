...
- Migrated the application to `uv` for package and dependency management.
    - Revised Dockerfile to use `uv`.
    - Revised GitHub Actions workflows to use `uv` for dependency installation and testing.
- Create this changelog file with all project history.
